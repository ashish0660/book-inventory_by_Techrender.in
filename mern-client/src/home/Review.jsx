            ...
            <div className="space-y-6">
              ...
              <div className="mt-7">
                <p className="mb-5">
                  ...
                  Sapiente velit distinctio tenetur nisi, vero quibusdam nihil
                  placeat. Ratione in sapiente recusandae! Voluptates
                  exercitationem ipsam qui ducimus vel dignissimos quisquam
                  rerum!
                </p>
